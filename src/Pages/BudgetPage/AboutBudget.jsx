...
function AboutBudget() {
    return (
        ...
        <section id='AboutBudget' className='flex flex-col flex-nowrap gap-[20px] items-start justify-start w-full h-auto p-[20px] dark:bg-darkslate bg-white'>
            ...
            <form className='flex flex-col flex-nowrap items-start justify-center gap-[10px] w-full h-auto p-[10px] dark:bg-gray bg-slate rounded-[10px]'>
                ...
                <label htmlFor="Residencial" className='flex flex-row flex-nowrap items-center justify-start gap-[10px] w-full h-auto font-Stara dark:text-white text-darkslate text-[1rem]'><input type="radio" name="Service" id="Residencial" value='Residencial'/>Mudança Residencial</label>

                <label htmlFor="Comercial" className='flex flex-row flex-nowrap items-center justify-start gap-[10px] w-full h-auto font-Stara dark:text-white text-darkslate text-[1rem]'><input type="radio" name="Service" id="Comercial" value='Comercial'/>Mudança Comercial</label>

                <label htmlFor="Guarda Móveis" className='flex flex-row flex-nowrap items-center justify-start gap-[10px] w-full h-auto font-Stara dark:text-white text-darkslate text-[1rem]'><input type="radio" name="Service" id="Guarda Móveis" value='Guarda Móveis'/>Guarda Móveis</label>

                <label htmlFor="Suporte" className='flex flex-row flex-nowrap items-center justify-start gap-[10px] w-full h-auto font-Stara dark:text-white text-darkslate text-[1rem]'><input type="radio" name="Service" id="Suporte" value='Suporte'/>Suporte</label>
