...
function Advertisings() {
    return (
        <>
        <section id='Advertising' className='reveal 6:scroll-p-[40px] scroll-p-[20px] snap-x snap-mandatory overflow-x-scroll flex flex-row flex-nowrap items-start justify-start gap-[40px] w-full h-auto 6:px-[60px] 6:py-[40px] p-[20px] dark:bg-gray bg-darksky'>
