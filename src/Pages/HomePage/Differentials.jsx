...
function Differentials() {
    return (
        <>
        <section id='Differentials' className='flex flex-col flex-nowrap items-center justify-center gap-[20px] w-full h-auto p-[20px] dark:bg-darkslate bg-white'>
...
function Differential({Icon, Text}){
    return(
        <>
        <div className='overflow-hidden relative flex flex-row flex-nowrap items-center justify-start min-w-[280px] w-full h-[80px] pl-[60px] dark:bg-white bg-sky rounded-[20px]'>
