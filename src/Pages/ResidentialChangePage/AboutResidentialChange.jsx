...
function AboutResidentialChange() {
    return (
        <>
        <section id='AboutResidentialChange' className='flex flex-col flex-nowrap items-center justify-center gap-[10px] w-full h-auto dark:bg-darkslate bg-white p-[20px]'>
